...
function generateList(){
    ...
    for (var i = 0; i < 7; i++){
        markup += "<a id ='reservation"+i+"' onclick='viewDetailsofReservation("+i+")' href='#' class='list-group-item'><h4 class='list-group-item-heading'>"+timeArr[i]+"</h4></a>";
    }

    $("#reservationList").html(markup);
}

function viewDetailsofReservation(i){
...
function viewDetailsofAssignReservation(i){
    // alert("hello"+i);
